    ...
    Returns:
        A tuple of tensors:
            ...
            embeddings_indices: Tensor of shape [2, batch_size] mapping
                requests to embedding indices. The first row is reserved
                (all zeros after removing extra vocab support); the second
                row provides the offsets for the LoRA `lora_a` embeddings.
